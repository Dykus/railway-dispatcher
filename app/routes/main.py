# -*- coding: utf-8 -*-
"""
Основные маршруты: главная страница, добавление, перемещение, архивация.
"""
...
from app.models import (
    ...
    find_slot_on_track, compact_track, get_conn, clean_note_for_db
)
from app.utils import is_return_track

main_bp = Blueprint('main', __name__)

# ==================== HTML-ШАБЛОН ГЛАВНОЙ СТРАНИЦЫ ====================
# Временно оставляем здесь, позже перенесём в templates/index.html
